...
class Kepala_puskes extends CI_Controller {
...
public function __construct(){
	...
	public function index()
	{
		...
		$data['child_menu'] = $child_menu;
			...
			if ($data['user']->row()->level == "kepala puskesmas") {
					$this->load->view('kepala_puskes/header', $data);
					//$this->load->view('admin/beranda', $data);
					$this->load->view('kepala_puskes/nav', $data);
					$this->load->view('kepala_puskes/footer');
			}else{
