...
class Partus extends CI_Controller {


	public $menuID 	= 4;
	public $name 	= 'Pertolongan Partus';

	public function __construct(){
        parent::__construct();
		$this->load->model('M_partus');
	...
	public function index(){
		...
		$this->load->view('m_bersalin/v_partus',$data);
	}
	...
	public function insert(){
		...
		if($status == 1){
			...
			$id_partus 	= $this->M_partus->create_no_transaction();
			...
			$this->M_partus->save_data($data_insert);
			...
			$this->M_partus->update_data($data,$code);
	...
	public function print_data($start_date='',$end_date='',$id_partus='',$partus=''){
		$id_partus		= str_replace('__', '/', $id_partus);
		$start_date 		= str_replace('__', '-', $start_date);
		$end_date 			= str_replace('__', '-', $end_date);

		$partus				= str_replace('__', ',', $partus);
		$partus				= str_replace('%20', ' ', $partus);
        ...
        $data_list 		= $this->M_partus->get_list_partus($start_date,$end_date,$id_partus,$partus);
        $list 			= $data_list['list'];
        ...
        for($x=0;$x<$total_page;$x++){
		    ...
		    $html .= "<table width='100%' cellpadding='5' cellspacing='0'>"
		    		."<tr>"
		    		."<td colspan='7' align='center'><h3>Laporan Pertolongan Partus</h3>"
		    		."</td>"
		    		."</tr>"
		    		."<tr>";
		    ...
		    if($total_baris < $max_baris){
		    	$body 	= "<tr>"
				    		...
				    		."<td class='bdr-right bdr-top bdr-bottom'>Id partus</td>"
							."<td class='bdr-right bdr-top bdr-bottom'>Pertlg partus</td>"
