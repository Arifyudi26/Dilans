...
class Pemeriksaan_umum extends CI_Controller {
	...
	*/
	...
	public $menuID 	= 11;
	public $name 	= 'Pemeriksaan Umum'; 

	public function __construct(){
        parent::__construct();
		$this->load->model('M_pemeriksaan_umum');
		$this->load->model('M_menu_pemeriksaan');
	...
	public function ajax(){
		$get_pemeriksaan = $this->M_pemeriksaan_umum->get_all();
		//echo $this->db->last_query();
		echo json_encode($get_pemeriksaan);
	}
    
	function get_list_unit(){
		$list_unit = $this->M_pemeriksaan_umum->m_get_list_unit();
	...
	public function index(){
		...
		$data['menu_link'] 	= $this->M_menu_pemeriksaan->get_menu($this->menuID);
		$data['date_now'] 	= date('Y-m-d');

		$this->load->view('pemeriksaan/header1');
	...
	public function add(){
		$data['menu_link'] = $this->M_menu_pemeriksaan->get_menu($this->menuID);
		$data['date_now'] 	= date('Y-m-d');
		$data['TransNumber'] 	= $this->M_pemeriksaan_umum->create_no_transaction();	
		$this->load->view('pemeriksaan/header1');
		$this->load->view('pemeriksaan/new_data_pemeriksaan',$data);
	...
	public function edit($id_pemeriksaan){
		...
		$data['menu_link'] 	= $this->M_menu_pemeriksaan->get_menu($this->menuID);	
		$data['date_now'] 	= date('Y-m-d');
		$data['group'] 		= $this->M_pemeriksaan_umum->m_get_group($id_pemeriksaan);
		$this->load->view('pemeriksaan/header1');
		$this->load->view('pemeriksaan/edit_data_pemeriksaan',$data);
		$this->load->view('pemeriksaan/footer1');
	}
	...
	function get_list_pasien(){
		...
		$list_pasien 		= $this->M_pemeriksaan_umum->m_get_list_pasien($kd_pasien,$nama);
		// echo $this->db->last_query();
		// die();
	...
	public function insert(){
		...
		$id_berobat		    = $this->input->post('id_berobat');
           ...
           $data_priksa = array('trans_status'=>1);
			...
			$this->insert_data($id_pemeriksaan,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$keluhan,$tb,$bb,$ss,$ds,$rr,$hr,$unit,$id_berobat,$date);
			$this->M_pemeriksaan_umum->m_false_data($data_priksa,$id_berobat);
	...
	function insert_data($id_pemeriksaan,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$keluhan,$tb,$bb,$ss,$ds,$rr,$hr,$unit,$id_berobat,$date){
		$data = array(
		...
		$this->M_pemeriksaan_umum->m_insert_data($data);
	}
	...
	public function update(){
		...
		$this->update_data($id_pemeriksaan,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$keluhan,$tb,$bb,$ss,$ds,$rr,$hr,$unit,$id_berobat,$status,$date);
	...
	function update_data($id_pemeriksaan,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$keluhan,$tb,$bb,$ss,$ds,$rr,$hr,$unit,$id_berobat,$status,$date){
		...
		$this->M_pemeriksaan_umum->m_update_group($data_pemeriksaan,$id_pemeriksaan);
	}
    ...
    function suspend_data(){
		...
		$this->M_pemeriksaan_umum->m_suspend_data($data_suspend,$no_transaction);
