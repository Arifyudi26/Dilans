...
class Poli_gizi_anak extends CI_Controller {
	...
	*/
	...
	public $menuID 	= 9;
	public $name 	= 'Poli Gizi Anak';

	public function __construct(){
        parent::__construct();
		$this->load->model('M_poli_gizi_anak');
	...
	public function ajax(){
		$get_tindakan = $this->M_poli_gizi_anak->get_all();
	...
	function get_list_dokter(){
		$list_dokter = $this->M_poli_gizi_anak->m_get_list_dokter();
	...
	public function index(){
		...
		$this->load->view('poli_gizi/data_gizi_anak',$data);
	}

	public function add(){
		$data['menu_link'] = $this->M_menu_poli_gizi->get_menu($this->menuID);
		$data['date_now'] 	= date('Y-m-d');
		$data['TransNumber'] 	= $this->M_poli_gizi_anak->create_no_transaction();	
		$this->load->view('poli_gizi/header1');
		$this->load->view('poli_gizi/new_gizi_anak',$data);
		$this->load->view('poli_gizi/footer');
	}

	public function preview($id_gza){

		$data['menu_link'] 	= $this->M_menu_poli_gizi->get_menu($this->menuID);	
		$data['date_now'] 	= date('Y-m-d');
		$data['group'] 		= $this->M_poli_gizi_anak->m_get_group($id_gza);
		$this->load->view('poli_gizi/header1');
		$this->load->view('poli_gizi/prev_gizi_anak',$data);
		$this->load->view('poli_gizi/footer');
	...
	function get_list_pasien(){
		...
		$list_pasien 		= $this->M_poli_gizi_anak->m_get_list_pasien($kd_pasien,$nama);
		// echo $this->db->last_query();
		// die();
	...
	function get_list_diagnosa(){
		...
		$list_diagnosa 		= $this->M_poli_gizi_anak->m_get_list_diagnosa($id_diagnosa,$des_icd);
		// echo $this->db->last_query();
		// die();
	...
	public function insert(){
		...
		$id_gza 		= $this->M_poli_gizi_anak->create_no_transaction();	
		...
		$id_pg 		  		= $this->input->post('id_pg_anak');
		$status		  		= $this->input->post('status');

			/*================== transaction begin ======================*/
			$this->db->trans_begin();

			$this->insert_data($id_gza,$kd_pasien,$nama,$tt_lahir,$alamat,$bpjs,$no,$akd,$po,$dm,$bbl,$pbl,$uk,$kelahiran,$tb,$bb,$imt,$bio,$fk,$ae,$msa,$am,$mp,$lh,$lb,$sayur,$buah,$selingan,$diag,$des,$id_pg,$status);
	...
	function insert_data($id_gza,$kd_pasien,$nama,$tt_lahir,$alamat,$bpjs,$no,$akd,$po,$dm,$bbl,$pbl,$uk,$kelahiran,$tb,$bb,$imt,$bio,$fk,$ae,$msa,$am,$mp,$lh,$lb,$sayur,$buah,$selingan,$diag,$des,$id_pg,$status){
		$data_gizi = array(
						'ID_GIZI_ANAK'	 	=> $id_gza,
		...
		$this->M_poli_gizi_anak->m_insert_data($data_gizi);
	}
	...
	public function update(){
		...
		$this->update_data($id_gza,$kd_pasien,$nama,$tt_lahir,$alamat,$bpjs,$no,$akd,$po,$dm,$bbl,$pbl,$uk,$kelahiran,$tb,$bb,$imt,$bio,$fk,$ae,$msa,$am,$mp,$lh,$lb,$sayur,$buah,$selingan,$diag,$des,$id_pg,$status);
	...
	function update_data($id_gza,$kd_pasien,$nama,$tt_lahir,$alamat,$bpjs,$no,$akd,$po,$dm,$bbl,$pbl,$uk,$kelahiran,$tb,$bb,$imt,$bio,$fk,$ae,$msa,$am,$mp,$lh,$lb,$sayur,$buah,$selingan,$diag,$des,$id_pg,$status){
		$data_gizi = array(
						'KODE_PASIEN' 		=> $kd_pasien,
						'NAMA_LENGKAP' 		=> $nama,
						'TEMPAT_TGL_LAHIR'  => $tt_lahir,
		...
		$this->M_poli_gizi_anak->m_update_data($data_gizi,$id_gza);
	}
