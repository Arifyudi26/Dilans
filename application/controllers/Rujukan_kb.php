...
class Rujukan_kb extends CI_Controller {
	...
	*/
	...
	public function ajax(){
		$get_rujukan = $this->M_rujukan_kb->get_all();
	...
	function get_list_dokter(){
		$list_dokter = $this->M_rujukan_kb->m_get_list_dokter();
		echo json_encode($list_dokter);
	}
	
	function get_list_poli(){
		$list_poli = $this->M_rujukan_kb->m_get_list_poli();
	...
	public function add(){
		$data['menu_link'] = $this->M_menu_poli_kb->get_menu($this->menuID);
		$data['date_now'] 	= date('Y-m-d');
		$data['TransNumber'] 	= $this->M_rujukan_kb->create_no_transaction();	
		$this->load->view('poli_kb/header1');
		$this->load->view('poli_kb/new_rujukan_kb',$data);
	...
	public function preview($id_rujukan){
		...
		$data['menu_link'] 	= $this->M_menu_poli_kb->get_menu($this->menuID);	
		$data['date_now'] 	= date('Y-m-d');
		$data['group'] 		= $this->M_rujukan_kb->m_get_group($id_rujukan);
		$this->load->view('poli_kb/header1');
		$this->load->view('poli_kb/prev_data_rujukan',$data);
		$this->load->view('poli_kb/footer');
	}
	...
	function get_list_diagnosa(){
		...
		$list_diagnosa 		= $this->M_rujukan_kb->m_get_list_diagnosa($id_diagnosa,$des_icd);
		// echo $this->db->last_query();
		// die();
    ...
    $pasien = $this->M_rujukan_kb->kd_pasien($kd);
	...
	public function insert(){
		...
		$id_rujukan 		= $this->M_rujukan_kb->create_no_transaction();	
	...
	function insert_data($id_rujukan,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$polrim,$petugas,$yth,$poli_rujukan,$pemeriksaan,$diagnosa,$des,$terapi,$id_berobat,$status,$date){
		...
		$this->M_rujukan_kb->m_insert_data($data_rujukan);
	}
	...
	function update_data($id_rujukan,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$polrim,$petugas,$yth,$poljuk,$pemeriksaan,$id_diag,$des,$terapi,$id_berobat,$date,$status){
		...
		$this->M_rujukan_kb->m_update_data($data,$id_rujukan);
	}
