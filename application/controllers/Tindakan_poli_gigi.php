...
class Tindakan_poli_gigi extends CI_Controller {
	...
	*/
	...
	public function ajax(){
		$get_tindakan = $this->M_poli_gigi->get_all();
	...
	function get_list_dokter(){
		$list_dokter = $this->M_poli_gigi->m_get_list_dokter();
	...
	public function index(){
		...
		$this->load->view('poli_gigi/data_poli_gigi',$data);
	}

	public function add(){
		$data['menu_link'] = $this->M_menu_poli_gigi->get_menu($this->menuID);
		$data['date_now'] 	= date('Y-m-d');
		$data['TransNumber'] 	= $this->M_poli_gigi->create_no_transaction();	
		$this->load->view('poli_gigi/header1');
		$this->load->view('poli_gigi/new_data_poli_gigi',$data);
		$this->load->view('poli_gigi/footer1');
	}

	public function preview($id_poli_gigi){

		$data['menu_link'] 	= $this->M_menu_poli_gigi->get_menu($this->menuID);	
		$data['date_now'] 	= date('Y-m-d');
		$data['group'] 		= $this->M_poli_gigi->m_get_group($id_poli_gigi);
		$this->load->view('poli_gigi/header1');
		$this->load->view('poli_gigi/prev_poli_gigi',$data);
		$this->load->view('poli_gigi/footer1');
	}
	...
	function get_list_diagnosa(){
		...
		$list_diagnosa 		= $this->M_poli_gigi->m_get_list_diagnosa($id_diagnosa,$des_icd);
		// echo $this->db->last_query();
		// die();
    ...
    $pasien = $this->M_poli_gigi->kd_pasien($kd);
	...
	public function insert(){
		...
		$id_poli_gigi 		= $this->M_poli_gigi->create_no_transaction();	
		...
		$status		  		= $this->input->post('status');
			...
			$this->insert_data($id_poli_gigi,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$ss,$ds,$rr,$hr,$alergi,$dm,$hp,$lain2,$anamnese,$pd,$diagnosa,$deskripsi,$tindakan,$id_dokter,$id_pemeriksaan,$status,$date);
	...
	function insert_data($id_poli_gigi,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$ss,$ds,$rr,$hr,$alergi,$dm,$hp,$lain2,$anamnese,$pd,$diagnosa,$deskripsi,$tindakan,$id_dokter,$id_pemeriksaan,$status,$date){
		$data_gigi = array(
		...
		$this->M_poli_gigi->m_insert_data($data_gigi);
	}
	...
	public function update(){
		...
		$id_poli_gigi 		= $this->input->post('code');	
		$kd_pasien      	= $this->input->post('kd_pasien');
		$nama     	 		= $this->input->post('nm_lengkap');
		$jenis			 	= $this->input->post('jenis');
		$umur				= $this->input->post('umur');
		...
		$this->update_data($id_poli_gigi,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$ss,$ds,$rr,$hr,$alergi,$dm,$hp,$lain2,$anamnese,$pd,$diagnosa,$deskripsi,$tindakan,$id_dokter,$id_pemeriksaan,$status,$date);
	...
	function update_data($id_poli_gigi,$kd_pasien,$nama,$jenis,$umur,$alamat,$bpjs,$ss,$ds,$rr,$hr,$alergi,$dm,$hp,$lain2,$anamnese,$pd,$diagnosa,$deskripsi,$tindakan,$id_dokter,$id_pemeriksaan,$status,$date){
		$data_gigi = array(
						'KODE_PASIEN' 			=> $kd_pasien,
						'NAMA_LENGKAP' 			=> $nama,
						'JENIS_KELAMIN'  	=> $jenis,
		...
		$this->M_poli_gigi->m_update_data($data_gigi,$id_poli_gigi);
	}
