    ...
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h1 class="panel-title">Tabel Informasi Data Dokter</h1>
          ...
          <div class="panel-heading">
          <p><a class="btn btn-primary" href="<?php echo base_url('Admin/input_dokter');?>"><i class="glyphicon glyphicon-plus"></i> Tambah Dokter</a>

  			<a class="btn btn-danger" href="<?php echo base_url('Admin/cetak_pdf');?>" target="_blank"><i class="glyphicon glyphicon-print"></i> PDF</a>
			<a class="btn btn-success" href="<?php echo base_url('admin/cetak_excel');?>"><i class="glyphicon glyphicon-print"></i> Excel</a></p>
            </div>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?php echo $baris->SPESIALIST; ?></td>
                <td class="center">
        			 <form action="" method="post" id="delete">
           			 <input type="hidden" name="empty" value="empty">            
            		 <input type="hidden" name="id_dokter" value="<?php echo $baris->ID_DOKTER; ?>">            
      				 </form>        
                     <a  data-toggle="modal" data-target="#tambah-data" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i> Edit</a> <button class="btn btn-danger" form="delete"><i class="glyphicon glyphicon-trash"></i></button>
