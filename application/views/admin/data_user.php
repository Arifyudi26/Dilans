    ...
    <div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h1 class="panel-title">Tabel Informasi Data User ( Pengguna )</h1>
        ...
        <div class="panel panel-flat">
          <div class="panel-heading">
          <p><a class="btn btn-primary" href="<?php echo base_url('Admin/input_user');?>"><i class="glyphicon glyphicon-plus"></i> Tambah Dokter</a>

  			<a class="btn btn-danger" href="<?php echo base_url('Admin/cetak_user_pdf');?>" target="_blank"><i class="glyphicon glyphicon-print"></i> PDF</a>
			<a class="btn btn-success" href="<?php echo base_url('Admin/cetak_user_excel');?>"><i class="glyphicon glyphicon-print"></i> Excel</a></p>
          </div>
