		    		...
		    		<td>
		    			<table width="80%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                               ...
                               <input type="hidden" name="id_poli" id="id_poli" value="<?=$group->ID_RESEP_OBAT;?>" style="height:15px;width:250px;"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td >
                               <input class="easyui-textbox" type="text" name="diagnosa" id="deskripsi" value="<?=$group->DIAGNOSA;?>" data-options="required:true" onFocus="choose_list_diagnosa();" style="height:30px;width:230px"></input>
                              </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					    </table>
