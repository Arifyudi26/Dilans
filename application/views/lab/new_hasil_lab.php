...
<div class="easyui-layout" style="height:500px;width:100%" id="layout_<?= $menu_link->controller;?>">
	<div data-options="region:'north',title:'',iconCls:'icon-ok'" style="width:80%;height:160px;border:none;overflow:hidden">
		<form id="fm_hasil" action="<?= base_url().$menu_link->controller;?>/insert" method="post" enctype="multipart/form-data">
		    <table width="100%">
		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
				 				  ...
				 				  <td >
                  				  <input class="easyui-textbox" type="text" name="pemeriksaan" id="pemeriksaan"  data-options="required:true" onFocus="" style="height:30px;width:300px"></input>                              
                    </td>
				</tr>
				<tr><td colspan="2" height="5"></td></tr>
					    </table>
					...
					<td align="" valign="top">   
		    			<table width="20%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_hasil" id="id_hasil" value="<?=$gigi;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
		    			...
		    			<table>
                         <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="bpjs" id="bpjs"  data-options="required:true" style="height:30px;width:250px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                          <tr>
	...
	<div data-options="region:'center',title:'',iconCls:'icon-ok'" style="width:80%;height:260px;border:none;overflow:hidden">
		<table class="easyui-edatagrid" title="" style="height:250px" id="grid_detail"
		    ...
		    <thead>
		        <tr>
		            <th data-options="field:'ID_CEK_LAB',width:110">Id Cek lab</th>
		            <th data-options="field:'PRIKSA',width:220">Priksa</th>
                    ...
                    ">
                        <thead>
                            <tr>
                                ...
                                <th field="ID_CEK_LAB" data-options="field:'ID_CEK_LAB',width:80" sortable="true">Id Cek Lab</th>
                                <th field="PEMERIKSAAN_LAB" data-options="field:'PEMERIKSAAN_LAB',width:135" sortable="true">Pemerikaan Lab</th>
                                <th field="PRIKSA" data-options="field:'PRIKSA',width:100" sortable="true">Priksa</th>
                                <th field="NILAI_NORMAL" data-options="field:'NILAI_NORMAL',width:100" sortable="true">Nilai Normal</th>
                                <th field="SATUAN" data-options="field:'SATUAN',width:70" sortable="true">satuan</th>
                            </tr>
                        </thead>
                    </table>
                </td>
