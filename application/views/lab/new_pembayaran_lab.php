		    	...
		    	<tr>
					...
					<td align="" valign="top">   
		    			<table width="20%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_bayar" id="id_bayar" value="<?=$gigi;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
		    			...
		    			<table>
                          <tr>
                            ...
                            <tr>
					            ...
					            <td >
                               <input class="easyui-numberbox" data-options="required:true,precision:2,groupSeparator:'.',decimalSeparator:','" style="width:150px;height:30px" id="total_by" name="total_by" readonly="true">			                                
                               </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
		    					</td> 
