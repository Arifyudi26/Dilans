		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kd_pasien" value="<?=$group->KODE_PASIEN;?>" onKeyPress="search();" data-options="required:true" style="height:35px;width:200px"></input>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                               <input name="nm_lengkap" class="easyui-textbox"  type="text"id="nama" data-options="required:true" value="<?=$group->NAMA_LENGKAP;?>" style="height:35px;width:300px">	
	            	           <input type="hidden" name="status" id="status" value="<?=$group->status;?>"  style="height:15px;width:250px;"></input>
                               <input type="hidden" name="id_rujukan" id="id_rujukan"  value="<?=$group->ID_RUJUKAN_UMUM;?>" style="height:15px;width:250px;"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="jenis" id="jenis" value="<?=$group->JENIS_KELAMIN;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text"  name="bpjs" id="bpjs" value="<?=$group->NO_BPJS;?>"  data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_umb_umum" id="id_umb_umum" value="<?=$group->ID_UMB_UMUM;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
                        ...
                        <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="hasil" id="hasil" value="<?=$group->HASIL_PEMERIKSAAN;?>" data-options="multiline:true" style="height:85px;width:300px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                              <tr>
					    		...
					    		<td >
								<input class="easyui-textbox" type="text" name="terapi" id="terapi" value="<?=$group->TINDAKAN_TERAPI;?>" data-options="multiline:true" style="height:50px;width:300px"></input>					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
...
<script type="text/javascript">
	 ...
	 function print_preview(){
    	var transaction_no = $('#id_umb_umum').textbox('getValue');
