<div class="easyui-layout" style="height:500px;width:100%" id="layout_<?= $menu_link->controller;?>">
	<div data-options="region:'north',title:'',iconCls:'icon-ok'" style="width:80%;height:160px;border:none;overflow:hidden">
		<form id="fm_resep_obat" action="<?= base_url().$menu_link->controller;?>/insert" method="post" enctype="multipart/form-data">
		    <table width="100%">
		    	...
		    	<tr>
		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="diagnosa" id="diagnosa"  data-options="required:true" style="height:30px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					    </table>
					</td>
					<td align="" valign="top">
		    			<table width="20%" cellpadding="0" cellspacing="0">
		    				<tr>
		    					<td align="center" style="font-size:12px;background-color:#cccccc;width:200px;height:20px;border:1px solid black;text-valign:middle"><label >Id Resep Umum</label></td>
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_tu_obat" id="id_tu_obat" value="<?=$TransNumber;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
                    ...
                    <table id="list_pasien" class="easyui-datagrid" 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th field="DESKRIPSI_ICD" data-options="field:'DESKRIPSI_ICD',width:170" sortable="true">Diagnosa</th>
                            </tr>
                        </thead>
                    </table>
                </td>
