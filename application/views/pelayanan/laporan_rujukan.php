<div class="easyui-layout" style="height:450px;width:100%">
    <div data-options="region:'center',title:'Data Rujukan internal',iconCls:'icon-ok'" style="width:100%;height:450px">
        <div class="list-group">
          <button type="button" class="list-group-item" onClick="$('#dialog_rujukan').dialog('open')"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>&nbsp;&nbsp;Laporan data rujukan</button>
          <button type="button" class="list-group-item" onClick="$('#dialog_umb').dialog('open')"><span class="glyphicon glyphicon-book" aria-hidden="true"></span>&nbsp;&nbsp;Laporan data umpan balik rujukan</button>
...
<!--  Dialog list item -->
<div id="dialog_rujukan" class="easyui-dialog" title="Laporan Rujukan" style="width:30%;height:230px;background-color:#F8F8F8;padding:5px;top:5px" closed="true" data-options="modal:true" buttons="#dialog_buttton_list_pq">
...
<div id="dialog_buttton_list_pq" style="border:none;height:80px">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onClick="modal_close('dialog_rujukan');">Cancel</a>
</div>

<!--  Dialog list item -->
<div id="dialog_umb" class="easyui-dialog" title="Laporan Umpan Balik Rujukan" style="width:30%;height:230px;background-color:#F8F8F8;padding:5px;top:5px" closed="true" data-options="modal:true" buttons="#dialog_buttton_list_po">
    <form id="" method="post" novalidate>
...
<div id="dialog_buttton_list_po" style="border:none;height:80px">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onClick="modal_close('dialog_umb');">Cancel</a>
</div>
...
function print(mn){
    if(mn =='pq'){
        ...
        if(tgl1!='' && tgl2 !=''){
            ...
            parent.printPanel('Laporan Rujukan Internal','<?= $menu_link->controller;?>/print_rujukan',mn,startDate,endDate,'','');
        ...
        if(tgl1!='' && tgl2 !=''){
            ...
            parent.printPanel('Laporan UMB Rujukan','<?= $menu_link->controller;?>/print_umb',mn,startDate,endDate,'','');
