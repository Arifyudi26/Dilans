...
<div class="easyui-layout" style="height:450px;width:100%">
	<div data-options="region:'east',split:true" title="Filter" style="width:20%;height:450px">
		<br>
		<p><input class="easyui-textbox" type="text" name="txt_id" id="txt_id" data-options="prompt:'Id pembayaran lab'" style="height:25px;width:200px"></p>
	...
	<div data-options="region:'center',title:'List data pembayaran laboratorium',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        pagination:true,
                pageSize:20,
		        url:'<?= base_url().$menu_link->controller;?>/bayar_lab',
		        method:'get',
		        toolbar:toolbar,
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_PEMBAYARAN_LAB',width:120">Id Pembayaran Lab</th>
                    ...
                    <th data-options="field:'TGL_BAYAR',width:150">Tanggal</th>
                    <th data-options="field:'nama',width:150">Nama Dokter</th>
                     <th data-options="field:'TOTAL_BIAYA',width:100,align:'center'">Total Biaya</th>
                    <th data-options="field:'ID_DAFTAR_LAB',width:150">Id daftar lab</th>
...
<script type="text/javascript">
    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	parent.editPanel('Prev detail bayar lab','<?= $menu_link->controller;?>/preview_blab',row.ID_PEMBAYARAN_LAB);
        }
    }];
