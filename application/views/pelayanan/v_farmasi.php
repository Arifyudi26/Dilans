...
<div class="easyui-layout" style="height:450px;width:100%">
	<div data-options="region:'east',split:true" title="Filter" style="width:20%;height:450px">
		<br>
		<p><input class="easyui-textbox" type="text" name="txt_id" id="txt_id" data-options="prompt:'Id Farmasi'" style="height:25px;width:200px"></p>
	...
	<div data-options="region:'center',title:'List data farmasi',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        pagination:true,
                pageSize:20,
		        url:'<?= base_url().$menu_link->controller;?>/farmasi',
		        method:'get',
		        toolbar:toolbar,
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_FARMASI',width:120">Id Farmasi</th>
                    ...
                    <th data-options="field:'unit',width:150">Poli Pemeriksaan</th>
                     <th data-options="field:'nama',width:150">Petugas</th>
...
<script type="text/javascript">
    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	parent.editPanel('Prev detail ambil obat','<?= $menu_link->controller;?>/preview_ob',row.ID_FARMASI);
        }
    }];
