...
<div class="easyui-layout" style="height:450px;width:100%">
	...
	<div data-options="region:'center',title:'List data pemeriksaan umum',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        pagination:true,
                pageSize:20,
		        url:'<?= base_url().$menu_link->controller;?>/pemeriksaan',
		        method:'get',
			">
		    <thead>
		        <tr>
