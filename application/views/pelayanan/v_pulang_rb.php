...
<div class="easyui-layout" style="height:450px;width:100%">
	<div data-options="region:'east',split:true" title="Filter" style="width:20%;height:450px">
		<br>
		<p><input class="easyui-textbox" type="text" name="txt_id" id="txt_id" data-options="prompt:'Id Pulang RB'" style="height:25px;width:200px"></p>
	...
	<div data-options="region:'center',title:'List data pulang ruang bersalin',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        pagination:true,
                pageSize:20,
		        url:'<?= base_url().$menu_link->controller;?>/pulang_rb',
		        method:'get',
		        toolbar:toolbar,
		        onDblClickRow:function(){
					...
					if(priedit == false){
        				parent.editPanel('Preview detail pulang RB','<?=$menu_link->controller;?>/preview_rb',row.ID_PULANG_RB);
        			}
				}
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_PULANG_RB',width:120,align:'center'">Id Pulang RB</th>
                    ...
                    <th data-options="field:'TGL_PULANG',width:150,align:'center'">Tgl pulang</th>
                     <th data-options="field:'TOTAL_BIAYA',width:150,align:'center'">Total Biaya</th>
                    <th data-options="field:'nama',width:150,align:'center'">Petugas</th>
                    <th data-options="field:'ID_DAFTAR_RB',width:150,align:'center'">Id daftar Rb</th>
