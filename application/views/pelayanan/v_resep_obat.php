...
<div class="easyui-layout" style="height:450px;width:100%">
	<div data-options="region:'east',split:true" title="Filter" style="width:20%;height:450px">
		<br>
		<p><input class="easyui-textbox" type="text" name="txt_id" id="txt_id" data-options="prompt:'Id TU obat'" style="height:25px;width:200px"></p>
	...
	<div data-options="region:'center',title:'List data resep obat ',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        pagination:true,
                pageSize:20,
		        url:'<?= base_url().$menu_link->controller;?>/resep',
		        method:'get',
		        toolbar:toolbar,
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_TU_OBAT',width:120">Id TO obat</th>
...
<script type="text/javascript">
    var toolbar = [{
        ...
        handler:function(){
        	...
        	parent.editPanel('Preview detail resep','<?= $menu_link->controller;?>/edit',row.ID_TU_OBAT);
        }
    }];
