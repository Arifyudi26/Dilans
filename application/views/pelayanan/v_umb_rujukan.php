...
<div class="easyui-layout" style="height:450px;width:100%">
	...
	<div data-options="region:'center',title:'List Umpan balik rujukan',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        pagination:true,
                pageSize:20,
		        url:'<?= base_url().$menu_link->controller;?>/umb_rujukan',
		        method:'get',
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_UMB_UMUM',width:120">Id Umb Rujukan</th>
                    ...
                    <th data-options="field:'ID_POLI_UMUM',width:150">Id poli umum</th>
