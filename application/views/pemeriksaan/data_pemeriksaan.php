	...
	<div data-options="region:'center',title:'List <?=$menu_link->MenuLabel;?>',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        onDblClickRow:function(){
					...
					if(priedit == false){
        				parent.editPanel('Edit <?=$menu_link->MenuLabel;?>','<?=$menu_link->controller;?>/edit',row.ID_PEMERIKSAAN);
        			}
				}
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_PEMERIKSAAN',width:120">Id pemeriksaan</th>
                    ...
                    <th data-options="field:'HEART_RATE',width:150">Heart Rate</th>
                     <th data-options="field:'unit',width:150">Poli tujuan</th>
                    <th data-options="field:'ID_BEROBAT',width:150">Id Kunjungan</th>
...
<script type="text/javascript">
    ...
    var toolbar = [{
        ...
        handler:function(){
        	var row = $('#grid').datagrid('getSelected');
			var transaction_no = row.ID_PEMERIKSAAN;
        	if(row.status == 0){
