 <br>   
      <form id="fm_<?= $menu_link->controller;?>" action="<?= base_url().$menu_link->controller;?>/update" method="post" enctype="multipart/form-data">
		    <table width="100%">
		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kd_pasien" value="<?=$group->KODE_PASIEN;?>" data-options="required:true" style="height:35px;width:200px"></input> <a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:35px;" iconCls="icon-search" id="btn-search" onClick="cari();">Cari</a> 
                            ...
                            <tr>
					            ...
					            <td >
                               <input name="nm_lengkap" class="easyui-textbox"  type="text"id="nama" value="<?=$group->NAMA_LENGKAP;?>" data-options="required:true" style="height:35px;width:300px">			                               
                               </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="jenis" id="jenis" value="<?=$group->JENIS_KELAMIN;?>"  data-options="required:true" style="height:35px;width:300px"></input>					                              
                               </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="umur" id="umur" value="<?=$group->UMUR;?>" data-options="required:true" style="height:35px;width:300px"></input>					                               
                              </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text"  name="bpjs" id="bpjs" value="<?=$group->NO_BPJS;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                
                             </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="keluhan" id="keluhan" value="<?=$group->KELUHAN;?>" data-options="multiline:true" style="height:100px;width:350px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_pemeriksaan" id="id_pemeriksaan" value="<?=$group->ID_PEMERIKSAAN;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
                        ...
                        <tr>
					            ...
					            <td>
                                <input class="easyui-textbox" type="text" name="tb" id="tb" value="<?=$group->TINGGI_BADAN;?>"  data-options="required:true" style="height:35px;width:200px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                              <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="bb" id="bb" value="<?=$group->BERAT_BADAN;?>" data-options="required:true" style="height:35px;width:200px"></input>                                
                               </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                                <input class="easyui-textbox" type="text" name="ss" id="ss" value="<?=$group->SISTOLE;?>"  data-options="required:true" style="height:35px;width:200px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                              <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="ds" id="ds" value="<?=$group->DIASISTOLE;?>" data-options="required:true" style="height:35px;width:200px"></input>                              
                              </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="rr" id="rr" value="<?=$group->RASPIRATORY_RATE;?>" data-options="required:true" style="height:35px;width:200px"></input>    
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               ...
                               <td width="300" ><label style="font-size:12px">Heart Rate</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="hr" id="hr" value="<?=$group->HEART_RATE;?>" data-options="required:true" style="height:35px;width:200px"></input> 					                               
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
...
function cari() {
   ...
   function choose_list_pasien(){
    ...
    function save(){
               update_data('fm_<?= $menu_link->controller;?>');
			   }
