		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kd_pasien" onKeyUp="btn-search" data-options="required:true" style="height:28px;width:200px"></input> <a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:28px;" iconCls="icon-search" id="btn-search" onClick="search();">Cari</a>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                               <input name="nm_lengkap" class="form-control"  type="text"id="nama" data-options="required:true" style="height:28px;width:300px">	
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="tt_lahir" id="tt_lahir"  data-options="required:true" style="height:28px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                            ...
                            <tr>
					    		...
					    		<td >
                                <input class="form-control" type="text" name="agama" id="agama"  data-options="required:true" style="height:28px;width:300px"></input>						
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					    		...
					    		<td >
                                <input class="form-control" type="text" name="pendidikan" id="pendidikan"  data-options="required:true" style="height:28px;width:300px"></input>						
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					    		...
					    		<td >
                                <input class="form-control" type="text" name="pekerjaan" id="pekerjaan"  data-options="required:true" style="height:28px;width:300px"></input>						
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="bpjs" id="bpjs"  data-options="required:true" style="height:28px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                              <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="bb" id="bb"  data-options="required:true" style="height:28px;width:200px"></input>                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					    </table>
					</td>
					...
					<td align="" valign="top">
                        ...
                        <tr>
					    		...
					    		<td >
                                <input class="easyui-textbox" type="text"  name="imt" id="imt"  data-options="required:true" style="height:28px;width:250px"></input>   		
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                        <tr>
					            ...
					            <td>
                                <input class="easyui-textbox" type="text" name="lla" id="lla"  data-options="required:true" style="height:28px;width:250px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                          <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="lp" id="lp"  data-options="required:true" style="height:28px;width:250px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                                <input class="easyui-textbox" type="text" name="lpg" id="lpg"  data-options="required:true" style="height:28px;width:200px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                              <tr>
					            ...
					            <td >
                               <select class="easyui-combobox" style="height:28px;width:250px;" id="sg" name="sg" data-options="required:true">
                                <option value=""></option>
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="bio" id="bio"  data-options="required:true" style="height:28px;width:250px"></input>    
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               ...
                               <td width="300" ><label style="font-size:12px">Kondisi Umum</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="ku" id="ku"  data-options="required:true" style="height:28px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					        	<td ><label style="font-size:12px">Tekanan Darah</label></td>
					    		<td >
					    			<input class="easyui-textbox" type="text" name="td" id="td" data-options="required:true" style="height:28px;width:250px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="st" id="st" data-options="required:true" style="height:28px;width:250px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="klinis" id="klinis" data-options="multiline:true,required:true" style="height:30px;width:250px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
		    			</table>
...
<script type="text/javascript">
  ...
  $.ajax({
        ...
        url: baseurl + "Pem_gizi_dewasa/search", // Isi dengan url/path file php yang dituju
