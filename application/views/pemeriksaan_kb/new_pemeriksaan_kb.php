		    	...
		    	<tr>
		    			...
		    			<table width="85%" cellpadding="0" cellspacing="0">
                         <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">No Faskes KB</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="nkfk" id="nkfk"  data-options="required:true" style="height:30px;width:130px"> <label style="font-size:12px">Noser kartu</label>  <input class="easyui-textbox" type="text" name="nsk" id="nsk"  data-options="required:true" style="height:30px;width:140px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kd_pasien" data-options="required:true" style="height:30px;width:200px"></input> <a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:30px;" iconCls="icon-search" id="btn-search" onClick="search();">Cari</a>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="pendidikan" id="pendidikan"  data-options="required:true" style="height:30px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="pekerjaan" id="pekerjaan"  data-options="required:true" style="height:30px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="tahapan" id="tahapan"  data-options="required:true" style="height:30px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="ns" id="ns"  data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					...
					<td align="" valign="top">
                        ...
                        <tr>
					            ...
					            <td>
                                <select class="easyui-combobox"  id="pensum" name="pensum" style="height:30px;width:200px" data-options="required:true">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                               <select class="easyui-combobox" id="peksum" name="peksum" style="height:30px;width:200px" data-options="required:true">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                                <input class="easyui-textbox" type="text" name="ja" id="ja"  data-options="required:true" style="height:30px;width:200px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                                <input class="easyui-textbox" type="text" name="uat" id="uat"  data-options="required:true" style="height:30px;width:200px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                               <select class="easyui-combobox"  id="sk" name="sk" style="height:30px;width:200px" data-options="required:true">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                              <select class="easyui-combobox" id="kt" name="kt" style="height:30px;width:200px" data-options="required:true">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                                <input class="easyui-datebox" type="text" name="htg" id="htg"  data-options="required:true" style="height:25px;width:200px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                              <select class="easyui-combobox"  id="dh" name="dh" style="height:25px;width:200px" data-options="required:true">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                              ...
                              <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="bb" id="bb"  data-options="required:true" style="height:25px;width:200px"></input>                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="100"><label style="font-size:12px">Tekanan darah</label></td>
					            <td>
                                <input class="easyui-textbox" type="text" name="td" id="td"  data-options="required:true" style="height:30px;width:200px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
