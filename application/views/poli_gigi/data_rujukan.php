	...
	<div data-options="region:'center',title:'List <?=$menu_link->MenuLabel;?>',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        onDblClickRow:function(){
					...
					if(priedit == false){
        				parent.editPanel('Preview <?=$menu_link->MenuLabel;?>','<?=$menu_link->controller;?>/preview',row.ID_RUJUKAN_GIGI);
        			}
				}
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_RUJUKAN_GIGI',width:120">Id Rujukan</th>
...
<!-- ================== dialog add barang ============================== -->
<div id="dlg_rujukan" class="easyui-dialog" title="Form Edit rujukan internal umum" style="width:800px;height:400px;padding:10px" closed="true" modal="true"
            data-options="
                iconCls: 'icon-save',
                toolbar: toolbar_2
            ">
	    ...
	    <table cellpadding="5">
	        <tr>
	            ...
	            <td>
                    ...
                    <input type="hidden" name="id_poli_gigi" id="id_poli_gigi"  style="height:15px;width:250px;"></input>
	            </td>
	        </tr>
	        <tr><td colspan="2" height="5"></td></tr>
            <tr>
    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	if(row.status == 0){
				...
				$('#id_poli_gigi').val(row.ID_POLI_GIGI);
        ...
        handler:function(){
        	...
        	if(row.TransStatus == 0){
    			suspend_data('<?= $menu_link->controller;?>/suspend_data','grid',row.ID_RUJUKAN_GIGI);   
	        }
        }
    }];
