		    	...
		    	<tr>
		    			...
		    			<table width="85%" cellpadding="0" cellspacing="0">
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					    		...
					    		<td >
					    			<textarea class="form-control" type="text" name="alamat" id="alamat" data-options="multiline:true" style="height:45px;width:350px"></textarea>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                          ...
                          <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td>
                                <input class="form-control" type="text" name="alergi" id="alergi"  data-options="required:true" style="height:30px;width:250px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					    </table>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_poli_gigi" id="id_poli_gigi" value="<?=$TransNumber;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
                          <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="dm" id="dm"  data-options="required:true" style="height:30px;width:250px"></input>                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="hp" id="hp"  data-options="required:true" style="height:30px;width:250px"></input>    
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               ...
                               <td width="300" ><label style="font-size:12px">lain-lain</label></td>
					            <td >
					    	    <input class="easyui-textbox" type="text" name="lain2" id="lain2" data-options="multiline:true" style="height:4opx;width:250px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               ...
                               <td width="300" ><label style="font-size:12px">Anamnese</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="anamnese" id="anamnese"  data-options="required:true" style="height:30px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
...
<script type="text/javascript">
  ...
  $.ajax({
        ...
        url: baseurl + "Tindakan_poli_gigi/search", // Isi dengan url/path file php yang dituju
    ...
    success: function(response){ // Ketika proses pengiriman berhasil
		...
		$("#rr").val(response.rr);
		$("#hr").val(response.hr);
		$("#id_pemeriksaan").val(response.id_pemeriksaan);
