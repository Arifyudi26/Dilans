        <form id="fm_gigi" action="<?= base_url().$menu_link->controller;?>/insert" method="post" enctype="multipart/form-data">
		    <table width="100%">
		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kd_pasien" value="<?=$group->KODE_PASIEN;?>" onKeyUp="btn-search" data-options="required:true" style="height:30px;width:200px"></input> <a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:30px;" iconCls="icon-search" id="btn-search" onClick="search();">Cari</a>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="alamat" id="alamat" value="<?=$group->ALAMAT;?>" data-options="multiline:true" style="height:45px;width:350px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                          ...
                          <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="100"><label style="font-size:12px">Alergi</label></td>
					            <td>
                                <input class="easyui-textbox" type="text" name="alergi" id="alergi" value="<?=$group->ALERGI;?>" data-options="required:true" style="height:30px;width:250px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					    </table>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_poli_gigi" id="id_poli_gigi" value="<?=$group->ID_POLI_GIGI;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
                          <tr>
					            ...
					            <td width="300" ><label style="font-size:12px">DM</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="dm" id="dm" value="<?=$group->DM;?>" data-options="required:true" style="height:30px;width:250px"></input>                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>

					            <td width="300" ><label style="font-size:12px">Hipetensi</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="hp" id="hp" value="<?=$group->HIPETENSI;?>" data-options="required:true" style="height:30px;width:250px"></input>    
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                            
                               <td width="300" ><label style="font-size:12px">lain-lain</label></td>
					            <td >
					    	    <input class="easyui-textbox" type="text" name="lain2" id="lain2" value="<?=$group->LAIN_LAIN;?>" data-options="multiline:true" style="height:4opx;width:250px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                            
                               <td width="300" ><label style="font-size:12px">Anamnese</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="anamnese" id="anamnese" value="<?=$group->ANAMNESE;?>" data-options="required:true" style="height:30px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					        	<td ><label style="font-size:12px">PD</label></td>
					    		<td >
					    			<input class="easyui-textbox" type="text" name="pd" id="pd" value="<?=$group->PD;?>" data-options="multiline:true" style="height:50px;width:250px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					        	<td ><label style="font-size:12px">Tindakan</label></td>
					    		<td >
					    			<input class="easyui-textbox" type="text" name="tindakan" id="tindakan" value="<?=$group->TINDAKAN;?>" data-options="multiline:true" style="height:50px;width:250px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
