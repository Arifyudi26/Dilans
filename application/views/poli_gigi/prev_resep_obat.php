...
<div class="easyui-layout" style="height:500px;width:100%" id="layout_<?= $menu_link->controller;?>">
		    	...
		    	<tr>
		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="diagnosa" id="diagnosa" value="<?=$group->DIAGNOSA;?>"  data-options="required:true" style="height:30px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					...
					<td align="" valign="top">
		    			<table width="20%" cellpadding="0" cellspacing="0">
		    				<tr>
		    					<td align="center" style="font-size:12px;background-color:#cccccc;width:200px;height:20px;border:1px solid black;text-valign:middle"><label >Id Terapi obat Umum</label></td>
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_tou" id="id_tou" value="<?=$group->ID_RESOB_GIGI;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
	...
	<div data-options="region:'center',title:'',iconCls:'icon-ok'" style="width:80%;height:260px;border:none;overflow:hidden">
		<table class="easyui-edatagrid" title="" style="height:250px" id="grid_detail"
		        ...
		        pagination:false,
	            pageSize:50,
		        url:'<?= base_url().$menu_link->controller;?>/get_detail_resep/<?=$group->ID_RESOB_GIGI;?>',
		        method:'get',
		        toolbar:toolbar,
...
<script type="text/javascript">
  ...
  $.ajax({
        ...
        url: baseurl + "Terapi_obat_umum/search", // Isi dengan url/path file php yang dituju
