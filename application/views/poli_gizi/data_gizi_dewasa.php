	...
	<div data-options="region:'center',title:'List <?=$menu_link->MenuLabel;?>',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        onDblClickRow:function(){
					...
					if(priedit == false){
        				parent.editPanel('Preview <?=$menu_link->MenuLabel;?>','<?=$menu_link->controller;?>/preview',row.ID_GIZI_DEWASA);
        			}
				}
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_GIZI_DEWASA',width:120">Id Poli Gizi Dewasa</th>
                    ...
                    <th data-options="field:'L_PERUT',width:150">L_perut</th>
                    <th data-options="field:'L_PANGGUL',width:150">L Panggul</th>
                    ...
                    <th data-options="field:'ALERGI_MAKANAN',width:150">Alergi Mknan</th>
                    <th data-options="field:'MAKANAN_POKOK',width:150">Makanan Pokok</th>
                    <th data-options="field:'LAUH_HEWANI',width:150">Lauk Hewani</th>
                    <th data-options="field:'LAUH_NABATI',width:150">Lauk Nabati</th>
...
<div id="dlg_poli_gizi" class="easyui-dialog" title="Form Edit poli Gizi Dewasa" style="width:850px;height:420px;padding:10px" closed="true" modal="true"
            data-options="
                iconCls: 'icon-save',
                toolbar: toolbar_2
            ">
    <form id="fm_gizi" action="<?= base_url().$menu_link->controller;?>/update" method="post" enctype="multipart/form-data">
       <table width="100%">
	    ...
	    <table cellpadding="5">
	        <tr>
	            ...
	            <td>
                    ...
                    <input type="hidden" name="id_pg_dewasa" id="id_pg"  style="height:15px;width:250px;"></input>
	            </td>
	        </tr>
	        <tr><td colspan="2" height="5"></td></tr>
            <tr>
			 ...
			 <tr><td colspan="2" height="5"></td></tr>
              <tr>
                <td width="50" valign="top">IMT</label></td>
				 <td >
                  <input class="easyui-textbox" type="text" name="imt" id="imt"  data-options="required:true" style="height:25px;width:90px"> <label style="font-size:12px"> LL Atas -</label>  <input class="easyui-textbox" type="text" name="lla" id="lla"  data-options="required:true" style="height:25px;width:100px"></input> 					                   </td>
				  </tr>
			   <tr><td colspan="2" height="5"></td></tr>
                <tr>
                <td width="50" valign="top">L Perut</label></td>
				 <td >
                  <input class="easyui-textbox" type="text" name="lp" id="lp"  data-options="required:true" style="height:25px;width:90px"> <label style="font-size:12px"> L Panggul </label><input class="easyui-textbox" type="text" name="lpg" id="lpg"  data-options="required:true" style="height:25px;width:100px"></input> 					                   </td>
				  </tr>
			   <tr><td colspan="2" height="5"></td></tr>
                <tr>
                <td width="50" valign="top">Status Gizi</label></td>
				 <td >
                  <input class="easyui-textbox" type="text" name="sg" id="sg"  data-options="required:true" style="height:25px;width:90px"> <label style="font-size:12px"> Biokimia </label>  <input class="easyui-textbox" type="text" name="bio" id="bio"  data-options="required:true" style="height:25px;width:100px"></input> 					                   </td>
				  </tr>
			   <tr><td colspan="2" height="5"></td></tr>
        ...
        <td align="right" valign="top">
           ...
           <tr>
				  <td width="50" valign="top">Kondisi Umum</label></td>
				  <td >
			 ...
			 <tr><td colspan="2" height="5"></td></tr>
             <tr>
                <td width="50" valign="top">Tekanan darah</label></td>
				 <td >
                  <input class="easyui-textbox" type="text" name="td" id="td"  data-options="required:true" style="height:25px;width:90px"> <label style="font-size:12px"> Suhu Tbh </label>  <input class="easyui-textbox" type="text" name="st" id="st"  data-options="required:true" style="height:25px;width:100px"></input> 					                   </td>
				  </tr>
			   <tr><td colspan="2" height="5"></td></tr>
                
            <tr>
				  <td width="50" valign="top">Klinis</label></td>
				  <td >
				 <input class="easyui-textbox" type="text" name="klinis" id="kli" data-options="multiline:true,required:true" style="height:40px;width:250px"></input>
				 </td>
				</tr>
			 <tr><td colspan="2" height="5"></td></tr>
    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	if(row.status == 0){
				...
				$('#lp').textbox('setValue',row.L_PERUT);
				$('#lpg').textbox('setValue',row.L_PANGGUL);
				...
				$('#kli').textbox('setValue',row.KLINIS);
				$('#am').textbox('setValue',row.ALERGI_MAKANAN);
				$('#mp').textbox('setValue',row.MAKANAN_POKOK);
				$('#lh').textbox('setValue',row.LAUH_HEWANI);
				$('#lb').textbox('setValue',row.LAUH_NABATI);
