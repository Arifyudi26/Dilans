	...
	<div data-options="region:'center',title:'List <?=$menu_link->MenuLabel;?>',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        onDblClickRow:function(){
					...
					if(priedit == false){
        				parent.editPanel('Preview <?=$menu_link->MenuLabel;?>','<?=$menu_link->controller;?>/preview',row.ID_RUJUKAN_GIZI);
        			}
				}
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_RUJUKAN_GIZI',width:120">Id Rujukan</th>
                    ...
                    <th data-options="field:'ID_BEROBAT',width:150,align:'center'" hidden="true"></th>
