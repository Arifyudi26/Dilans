		    	...
		    	<tr>
					...
					<td align="" valign="top">
                        ...
                        <tr>
					    		...
					    		<td >
					    			<textarea class="easyui-textbox" type="text" name="pemeriksaan" id="pemeriksaan" data-options="multiline:true" style="height:80px;width:300px"></textarea>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                              <tr>
					    		...
					    		<td >
					    			<textarea class="easyui-textbox" type="text" name="terapi" id="terapi"  data-options="multiline:true" style="height:70px;width:300px"></textarea>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
