		    	...
		    	<tr>
		    		<td>
		    			<table width="95%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="jenis" id="jenis" value="<?=$group->JENIS_KELAMIN;?>" data-options="required:true" style="height:30px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				<tr>
		    					<td align="center" style="font-size:12px;background-color:#cccccc;width:200px;height:20px;border:1px solid black;text-valign:middle"><label >Id Rujukan Gizi</label></td>
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_rujukan" id="id_rujukan" value="<?=$group->ID_RUJUKAN_GIZI;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
...
<script type="text/javascript">
  ...
  $.ajax({
        ...
        url: baseurl + "Rujukan_gizi/search", // Isi dengan url/path file php yang dituju
