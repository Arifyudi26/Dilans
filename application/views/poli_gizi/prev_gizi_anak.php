		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                               ...
                               <input type="hidden" name="id_pg_anak" id="id_pgizi" value="<?=$group->ID_PG_ANAK;?>" style="height:15px;width:250px;"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					    		...
					    		<td >
                                <input class="easyui-textbox" type="text" name="no" id="no" value="<?=$group->NAMA_ORTU;?>" data-options="required:true" style="height:25px;width:120px"> <label style="font-size:12px">Anak Ke</label>  <input class="easyui-textbox" type="text"  name="akd" id="akd" value="<?=$group->ANAK_KE;?>" data-options="required:true" style="height:25px;width:120px"></input>						
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text"  name="po" id="po" value="<?=$group->PEKERJAAN_ORTU;?>" data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text"  name="bbl" id="bbl" value="<?=$group->BB_LAHIR;?>" data-options="required:true" style="height:25px;width:120px"> <label style="font-size:12px">PB Lahir</label> <input class="easyui-textbox" type="text"  name="pbl" id="pbl" value="<?=$group->PB_LAHIR;?>" data-options="required:true" style="height:25px;width:120px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="100"><label style="font-size:12px">Umur Kehamilan</label></td>
					            <td>
                                <input class="easyui-textbox" type="text" name="uk" id="uk" value="<?=$group->UMUR_KEHAMILAN;?>" data-options="required:true" style="height:25px;width:120px"> <label style="font-size:12px">Kelahiran</label><input class="easyui-textbox" type="text" name="kelahiran" id="kelahiran" value="<?=$group->KELAHIRAN;?>" data-options="required:true" style="height:25px;width:120px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr> 
                             <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="fk" id="fk" value="<?=$group->FISIK_KLINIS;?>" data-options="multiline:true,required:true" style="height:25px;width:350px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_pga" id="id_pga" value="<?=$group->ID_GIZI_ANAK;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
                          <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="ae" id="ae" value="<?=$group->ASI_EKSEKUTIF;?>" data-options="required:true" style="height:25px;width:250px"></input>    
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Mkn Selain Asi</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="msa" id="msa" value="<?=$group->MKN_SELAIN_ASI;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Alergi Makanan</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="am" id="am" value="<?=$group->ALERGI_MKNAN;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                            ...
                            <tr>
                               <td width="300" ><label style="font-size:12px">Lauk hewani</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="lh" id="lh" value="<?=$group->LAUK_HEWANI;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Lauk Nabati</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="lb" id="lb" value="<?=$group->LAUK_NABATI;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
	...
	<div data-options="region:'south',title:'',iconCls:'icon-ok'" style="height:80px;border:none">
		 <table width="90%" cellpadding="0" cellspacing="0">
            <tr>
                <td>&nbsp;</td>
                <td align="right">
	                <a href="javascript:void(0)" class="easyui-linkbutton form-button save-button"  style="height:25px;" iconCls="icon-print" id="" onClick="save()">Print</a>
