		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kd_pasien" value="<?=$group->KODE_PASIEN;?>" onKeyPress="search();" data-options="required:true" style="height:35px;width:200px"></input><a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:35px;" iconCls="icon-search" id="btn-search" onClick="search();">Cari</a>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               ...
                               <input type="hidden" name="id_poli" id="id_poli" value="<?=$group->ID_PG_DEWASA;?>" style="height:15px;width:250px;"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="umur" id="umur" value="<?=$group->UMUR;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="bb" id="bb" value="<?=$group->BERAT_BADAN;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="tb" id="tb" value="<?=$group->TINGGI_BADAN;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="st" id="st" value="<?=$group->STATUS_GIZI;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					    </table>
					</td>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_umb_gigi" id="id_umb_gigi" value="<?=$group->ID_GIZI_IBU_HAMIL;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
		    			...
		    			<table width="85%" cellpadding="0" cellspacing="0">
                             ...
                             <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text"  name="monev" id="monev" value="<?=$group->MONEV_KE;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                         <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="hb" id="hb" value="<?=$group->HB_LILA;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                        ...
                        <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="inter" id="inter" value="<?=$group->INTERVENSI;?>" data-options="multiline:true,required:true" style="height:100px;width:300px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
