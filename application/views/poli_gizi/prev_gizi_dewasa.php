		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kode" value="<?=$group->KODE_PASIEN;?>" onKeyUp="btn-search" data-options="required:true" style="height:25px;width:200px"></input> <a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:25px;" iconCls="icon-search" id="btn-search" onClick="cari1();">Cari</a>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                               <input name="nm_lengkap" class="easyui-textbox"  type="text"id="nama" value="<?=$group->NAMA_LENGKAP;?>" data-options="required:true" style="height:25px;width:300px">	
	            	           <input type="hidden" name="status" id="status" value="<?=$group->status;?>" style="height:15px;width:250px;"></input>
                               <input type="hidden" name="id_pg_dewasa" id="id_pgizi" value="<?=$group->ID_PG_DEWASA;?>" style="height:15px;width:250px;"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="tt_lahir" id="tt_lahir" value="<?=$group->TEMPAT_TGL_LAHIR;?>" data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					           ...
					           <td ><label style="font-size:12px">Alamat</label></td>
					    		<td >
					    			<input class="easyui-textbox" type="text" name="alamat" id="almt" value="<?=$group->ALAMAT;?>" data-options="multiline:true,required:true" style="height:50px;width:350px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="agama" id="agama" value="<?=$group->AGAMA;?>" data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            <td width="300" ><label style="font-size:12px">Pendidikan</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="pendidikan" id="pendidikan" value="<?=$group->PENDIDIKAN;?>" data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            <td width="300" ><label style="font-size:12px">Pekerjaan</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="pekerjaan" id="pekerjaan" value="<?=$group->PEKERJAAN;?>" data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="300" ><label style="font-size:12px">No Bpjs</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="bpjs" id="bpjs" value="<?=$group->NO_BPJS;?>" data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="300" ><label style="font-size:12px">Diagnosa Medis</label></td>
					            <td >
                                <input class="easyui-textbox" type="text"  name="dm" id="dm" value="<?=$group->DIAGNOSA_MEDIS;?>" data-options="required:true" style="height:25px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="100"><label style="font-size:12px">Tinggi Badan</label></td>
					            <td>
                                <input class="easyui-textbox" type="text" name="tb" id="tb" value="<?=$group->TINGGI_BADAN;?>" data-options="required:true" style="height:25px;width:120px"> <label style="font-size:12px">Berat Bdn</label><input class="easyui-textbox" type="text" name="bb" id="bb" value="<?=$group->BERAT_BADAN;?>" data-options="required:true" style="height:25px;width:120px"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                               <td width="300" ><label style="font-size:12px">IMT</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="imt" id="imt" value="<?=$group->IMT;?>" data-options="required:true" style="height:25px;width:120px"> <label style="font-size:12px">LL Atas --</label>  <input class="easyui-textbox" type="text" name="lla" id="lla" value="<?=$group->LLA;?>" data-options="required:true" style="height:25px;width:120px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                               <td width="300" ><label style="font-size:12px">L Perut</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="lp" id="lp" value="<?=$group->L_PERUT;?>" data-options="required:true" style="height:25px;width:120px"> <label style="font-size:12px">L Panggul</label><input class="easyui-textbox" type="text" name="lpg" id="lpg" value="<?=$group->L_PANGGUL;?>" data-options="required:true" style="height:25px;width:120px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                               <td width="300" ><label style="font-size:12px">Status Gizi</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="sg" id="sg" value="<?=$group->STATUS_GIZI;?>" data-options="required:true" style="height:25px;width:120px"> <label style="font-size:12px">Biokimia </label>  <input class="easyui-textbox" type="text" name="bio" id="bio" value="<?=$group->BIOKIMIA;?>" data-options="required:true" style="height:25px;width:120px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_pga" id="id_pga" value="<?=$group->ID_GIZI_DEWASA;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
                         <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="ku" id="ku" value="<?=$group->KONDISI_UMUM;?>" data-options="multiline:true,required:true" style="height:40px;width:250px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                               <td width="300" ><label style="font-size:12px">Tekanan Darah</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="td" id="td" value="<?=$group->TEKANAN_DARAH;?>" data-options="required:true" style="height:25px;width:90px"> <label style="font-size:12px">Suhu Tbh</label><input class="easyui-textbox" type="text" name="st" id="st" value="<?=$group->SUHU_TUBUH;?>" data-options="required:true" style="height:25px;width:90px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					        	<td ><label style="font-size:12px">Klinis</label></td>
					    		<td >
					    			<input class="easyui-textbox" type="text" name="klinis" id="kli" value="<?=$group->KLINIS;?>" data-options="multiline:true,required:true" style="height:25px;width:250px"></input>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Alergi Makanan</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="am" id="am" value="<?=$group->ALERGI_MAKANAN;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Makanan pokok</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="mp" id="mp" value="<?=$group->MAKANAN_POKOK;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Lauk hewani</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="lh" id="lh" value="<?=$group->LAUH_HEWANI;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Lauk Nabati</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="lb" id="lb" value="<?=$group->LAUH_NABATI;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Sayur</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="sayur" id="sayur" value="<?=$group->SAYUR;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Buah</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="buah" id="buah" value="<?=$group->BUAH;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="300" ><label style="font-size:12px">Selingan</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="selingan" id="selingan" value="<?=$group->SELINGAN;?>" data-options="required:true" style="height:25px;width:250px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
