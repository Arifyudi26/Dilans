		    	...
		    	<tr>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				<tr>
		    					<td align="center" style="font-size:12px;background-color:#cccccc;width:200px;height:20px;border:1px solid black;text-valign:middle"><label >Id Umb Rujukan Gizi</label></td>
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_umb_gigi" id="id_umb_gigi" value="<?=$group->ID_UMB_GIZI;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
