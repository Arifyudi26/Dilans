		    	...
		    	<tr>
		    		<td>
		    			<table width="85%" cellpadding="0" cellspacing="0">
		    				<tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kd_pasien" value="<?=$group->KODE_PASIEN;?>" data-options="required:true" style="height:35px;width:200px"></input> <a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:35px;" iconCls="icon-search" id="btn-search" onClick="search();">Cari</a>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             ...
                             <tr>
					            ...
					            <td >
                                <input class="form-control" type="text"  name="htt" id="htt" value="<?=$group->HAID_TERAKHIR_TGL;?>" data-options="required:true" style="height:35px;width:300px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            ...
					            <td >
                                <input class="form-control" type="text" name="bb" id="bb" value="<?=$group->BERAT_BADAN;?>" data-options="required:true" style="height:35px;width:200px"></input>                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            ...
                            <tr>
                               ...
                               <td width="300" ><label style="font-size:12px">Tekanan Darah</label></td>
					            <td >
                                <input class="form-control" type="text" name="td" id="td" value="<?=$group->TEKANAN_DARAH;?>" data-options="required:true" style="height:35px;width:200px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="300" ><label style="font-size:12px">Tgl Datang</label></td>
					            <td >
                                <input class="easyui-datebox" type="text"  name="tgld" id="tgld" value="<?=$group->TGL_DATANG;?>" data-options="required:true" style="height:35px;width:200px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
					...
					<td align="" valign="top">
		    			<table width="90%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_kkb" id="id_kkb" value="<?=$group->ID_KUNJUNGAN_KB;?>" data-options="required:true" style="height:25px;width:250px" readonly="true"></input>
					    		</td>
					    		<td align="right">
		    			...
		    			<table width="90%" cellpadding="0" cellspacing="0">
                            <tr>
                               ...
                               <td width="150" ><label style="font-size:12px">Komplikasi Berat</label></td>
					            <td >
					    			<input class="easyui-textbox" type="text" name="klb" id="klb" value="<?=$group->KOMPLIKASI_BERAT;?>" data-options="multiline:true,required:true" style="height:80px;width:280px"></input>
                             </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                               <td width="100" ><label style="font-size:12px">Kegagalan</label></td>
					            <td >
                               <select class="easyui-combobox" id="gagal" name="kegagalan" style="height:35px;width:280px" data-options="required:true,value:'<?=$group->KEGAGALAN;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">Pemeriksaan</label></td>
					            <td >
					    			<input class="easyui-textbox" type="text" name="pemeriksaan" id="pemeriksaan" value="<?=$group->PEMERIKSAAN;?>" data-options="multiline:true,required:true" style="height:80px;width:280px"></input>
                             </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">Tgl Kembali</label></td>
					            <td >
                                <input class="easyui-datebox" type="text" name="tgk" id="tgk"  data-options="required:true" value="<?=$group->TGL_KEMBALI;?>" style="height:35px;width:280px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
					            <td width="50" ><label style="font-size:12px">Penanggung Jawab</label></td>
					            <td >
					            <select class="easyui-combogrid" style="width:280px;height:25px" id="pj" name="pj" data-options="
							            panelWidth: 500,
							            idField: 'NAMA_DOKTER',
