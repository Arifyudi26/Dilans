		    	...
		    	<tr>
		    		<td>
                        ...
                        <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="kd_pasien" id="kode" value="<?=$group->KODE_PASIEN;?>" onKeyUp="btn-search" data-options="required:true" style="height:25px;width:270px"></input> <a href="javascript:void(0)" class="easyui-linkbutton form-button" style="height:25px;" iconCls="icon-search" id="btn-search" onClick="cari();">Cari</a>
                                			                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                        <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">No Faskes KB</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="nkfk" id="nkfkb" value="<?=$group->NO_KD_FASKES_KB;?>" data-options="required:true" style="height:25px;width:130px"> <label style="font-size:12px">Noser kartu</label>  <input class="easyui-textbox" type="text" name="nsk" id="nskb" value="<?=$group->NO_SERI_KARTU;?>" data-options="required:true" style="height:25px;width:140px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					            ...
					            <td >
                               <input name="nm_lengkap" class="easyui-textbox"  type="text"id="nama" value="<?=$group->NAMA_LENGKAP;?>" data-options="required:true" style="height:25px;width:340px">	
                            ...
                            <tr>
					            ...
					            <td >
                                <input class="easyui-textbox" type="text" name="tt_lahir" id="tt_lahir" value="<?=$group->TEMPAT_TGL_LAHIR;?>" data-options="required:true" style="height:25px;width:340px"></input>					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
                               <td width="100" ><label style="font-size:12px">Umur </label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="umur" id="umur" value="<?=$group->UMUR;?>" data-options="required:true" style="height:25px;width:130px"> <label style="font-size:12px">No BPJS --</label> <input class="easyui-textbox" type="text" name="bpjs" id="bpjs" value="<?=$group->NO_BPJS;?>" data-options="required:true" style="height:25px;width:140px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr> 
                             ...
                             <tr>
                               <td width="100" ><label style="font-size:12px">Pendidikan</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="pendidikan" id="pendidikan" value="<?=$group->PENDIDIKAN;?>" data-options="required:true" style="height:25px;width:130px"> <label style="font-size:12px">Pekerjaan</label>  <input class="easyui-textbox" type="text" name="pekerjaan" id="pekerjaan" value="<?=$group->PEKERJAAN;?>" data-options="required:true" style="height:25px;width:140px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>   
                             ...
                             <tr>
					    		...
					    		<td >
					    			<input class="easyui-textbox" type="text" name="alamat" id="alamat" value="<?=$group->ALAMAT;?>" data-options="multiline:true,required:true" style="height:50px;width:350px"></textarea>
					    		</td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                             ...
                             <tr>
                               <td width="100" ><label style="font-size:12px">Tahapan KS</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="tks" id="tahapan" value="<?=$group->TAHAPAN_KS;?>" data-options="required:true" style="height:25px;width:130px"> <label style="font-size:12px">Nama Suami</label><input class="easyui-textbox" type="text" name="ns" id="ns" value="<?=$group->NAMA_SUAMI;?>" data-options="required:true" style="height:25px;width:130px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>  
                            ...
                            <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">kerjaan Suami</label></td>
					            <td >
                               <select class="easyui-combobox" id="peksum" name="peksum" style="height:25px;width:130px"  data-options="required:true,value:'<?=$group->PEKERJAAN_SUAMI;?>'">
                                <option value=""></option>
                                <option value="Pegawai Negri">Pegawai Negri</option>
                                <option value="Pegawai Swasta">Pegawai Swasta</option>
                                <option value="Pedagang">Pedagang</option>
                                </select> <label style="font-size:12px">Pendidikan s</label><select class="easyui-combobox"  id="pensum" name="pensum" style="height:25px;width:130px" data-options="required:true,value:'<?=$group->PENDIDIKAN_SUAMI;?>'">
                                <option value=""></option>
                            ...
                            <tr>
                               <td width="100" ><label style="font-size:12px">Jumlah Anak </label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="ja" id="ja" value="<?=$group->JUMLAH_ANAK;?>" data-options="required:true" style="height:25px;width:130px"> <label style="font-size:12px">Umur terkecil</label><input class="easyui-textbox" type="text" name="uat" id="uat" value="<?=$group->UMUR_ANAK_TERKECIL;?>" data-options="required:true" style="height:25px;width:130px"></input> 					                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>  
                            <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">Kb Terakhir</label></td>
					            <td >
                               <select class="easyui-combobox" id="ckt" name="kt" style="height:25px;width:130px" data-options="required:true,value:'<?=$group->CARA_KB_TERAKHIR;?>'">
                                <option value=""></option>
                                ...
                                </select> <label style="font-size:12px">Status KB - --</label> <select class="easyui-combobox"  id="sk" name="sk" style="height:25px;width:130px" data-options="required:true,value:'<?=$group->STATUS_KB;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>  
                             <tr>
                               <td width="100" ><label style="font-size:12px">Haid Terakhir</label></td>
					            <td >
                                <input class="easyui-datebox" type="text" name="ht" id="ht" value="<?=$group->HAID_TERAKHIR_TGL;?>" data-options="required:true" style="height:25px;width:130px"> <label style="font-size:12px">Diduga Hamil</label><select class="easyui-combobox"  id="dh" name="dh" style="height:25px;width:130px" data-options="required:true,value:'<?=$group->DUGAAN_HAMIL;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>  
                             <tr>
                               <td width="100" ><label style="font-size:12px">Tekanan darah</label></td>
					            <td >
                                <input class="easyui-textbox" type="text" name="td" id="td" value="<?=$group->TEKANAN_DARAH;?>" data-options="required:true" style="height:25px;width:130px"> <label style="font-size:12px">Berat Badan - </label><input class="easyui-textbox" type="text" name="bb" id="bb" value="<?=$group->BERAT_BADAN;?>" data-options="required:true" style="height:25px;width:130px">                          
                                  </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>               
					    </table>
					...
					<td align="" valign="top">
		    			<table width="90%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_poli_kb" id="id_poli_kb" value="<?=$group->ID_POLI_KB;?>" data-options="required:true" style="height:25px;width:250px" readonly="true"></input>
					    		</td>
					    		<td align="right">
		    			...
		    			<table width="90%" cellpadding="0" cellspacing="0">
                          <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">Menyusui</label></td>
					            <td >
                                <select class="easyui-combobox"  id="menyusui" name="menyusui" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->MENYUSUI;?>'">
                                <option value=""></option>
                                <option value="Ya">Ya</option>
                                <option value="Tidak">Tidak</option>
                                </select>              
					        ...
					        <tr><td colspan="2" height="5"></td></tr>  
                             <tr>
					    		...
					    		<td >
					    	    <select class="easyui-combobox" id="rp" name="rp" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->RPS;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                              <tr>
                               ...
                               <td width="100" ><label style="font-size:12px">Keadaan Umum</label></td>
					            <td >
                               <select class="easyui-combobox" id="ku" name="ku" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->KEADAAN_UMUM;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr> 
                             ...
                             <tr>
                               <td width="100" ><label style="font-size:12px">Posisi Rahim</label></td>
					            <td >
                                <select class="easyui-combobox" id="pr" name="pr" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->POSISI_RAHIM;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>   
                             <tr>
                               <td width="100" ><label style="font-size:12px">Sblm Pemeriksaan IUD/MOW cek dalam</label></td>
					            <td >
                                <select class="easyui-combobox" id="spi" name="spi" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->SPD;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>         
                             <tr>
                               <td width="100" ><label style="font-size:12px">Pemeriksaan Tambahan</label></td>
					            <td >
                                <select class="easyui-combobox" id="pt" name="pt" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->PEMERIKSAAN_TAMBAHAN;?>'">
                                <option value=""></option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>     
                             <tr>
                               <td width="100" ><label style="font-size:12px">Alat Kontrasepsi yg diperbolehkan</label></td>
					            <td >
                               <select class="easyui-combobox" id="akd" name="akd" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->AKBD;?>'">
                                <option value=""></option>
                                <option value="IUD">IUD</option>
                                <option value="MOW">MOW</option>
                                <option value="MOP">MOP</option>
                            ...
                            <tr>
                               <td width="100" ><label style="font-size:12px">Metodi atau Jenis yang dipilih</label></td>
					            <td >
                               <select class="easyui-combobox" id="mjd" name="mjd" style="height:25px;width:200px" data-options="required:true,value:'<?=$group->MJP;?>'">
                                <option value=""></option>
                                <option value="IUD">IUD</option>
                                <option value="MOW">MOW</option>
                                <option value="MOP">MOP</option>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>  
                             <tr>
                               <td width="100" ><label style="font-size:12px">Tanggal Dipesan</label></td>
					            <td >
                                 <input class="easyui-datebox" type="text" name="tgp" id="tgp" value="<?=$group->TGL_DIPESAN;?>" data-options="required:true" style="height:20px;width:200px"></input>
                                  </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>  
                            <tr>
                               <td width="100" ><label style="font-size:12px">Tanggal Dilayani</label></td>
					            <td >
                                <input class="easyui-datebox" type="text" name="tgd" id="tgd" value="<?=$group->TGL_DIPESAN;?>" data-options="required:true" style="height:20px;width:200px">                    
                                  </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr> 
                            <tr>
                               <td width="100" ><label style="font-size:12px">Tanggal Dicabut</label></td>
					            <td >
                                 <input class="easyui-datebox" type="text" name="tgc" id="tgc" value="<?=$group->TGL_DICABUT;?>" data-options="required:true" style="height:20px;width:200px" />                   
                                  </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr> 
                             <tr>
	...
	<div data-options="region:'south',title:'',iconCls:'icon-ok'" style="height:80px;border:none">
		 <table width="90%" cellpadding="0" cellspacing="0">
            <tr>
                <td>&nbsp;</td>
                <td align="right">
	                <a href="javascript:void(0)" class="easyui-linkbutton form-button save-button"  style="height:30px;" iconCls="icon-print" id="" onClick="save()">Print</a>
