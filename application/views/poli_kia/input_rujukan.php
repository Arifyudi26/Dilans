          ...
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold">Input Data Rujukan Internal</legend>
               <script src="<?php echo base_url("js/config_rujukan_kia.js"); ?>"></script> <!-- Load file process.js -->
            ...
            <form class="form-horizontal" action="" method="post">
              ...
              <a href="poli_kia/data_rujukan" class="btn btn-primary" style="float:right;margin-right:10px;">
                Tabel Data Rujukan
              </a>
            </form>
            </fieldset>
