    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h5 class="panel-title">Tabel Informasi Data Medical Record Poli Lansia</h5>
        ...
        <table class="table datatable-basic" width="100%">
          ...
          <tbody>
            <?php
            $no = 1;
            foreach ($medrec_lansia as $baris) {
            ?>
              <tr>
                <td><?php echo $no; ?></td>
                <td><?php echo $baris->ID_MEDREC_LANSIA; ?></td>
