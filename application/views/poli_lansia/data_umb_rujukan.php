	...
	<div data-options="region:'center',title:'List <?=$menu_link->MenuLabel;?>',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        onDblClickRow:function(){
					...
					if(priedit == false){
        				parent.editPanel('Preview <?=$menu_link->MenuLabel;?>','<?=$menu_link->controller;?>/preview',row.ID_UMB_LANSIA);
        			}
				}
			">
		    <thead>
		        <tr>
		            <th data-options="field:'ID_UMB_LANSIA',width:120">Id Umb Rujukan</th>
                    ...
                    <th data-options="field:'ID_POLI_LANSIA',width:150">Id poli umum</th>
...
<!-- ================== dialog add barang ============================== -->
<div id="dlg_umb" class="easyui-dialog" title="Form Edit umb rujukan Lansia" style="width:800px;height:400px;padding:10px" closed="true" modal="true"
              ...
              <tr>
               ...
               <tr>
				<td width="50" valign="top">Hasil Pemeriksaan</td>
				  <td >
					<textarea class="easyui-textbox" type="text" name="hasil" id="hasil" data-options="multiline:true,required:true" style="height:75px;width:250px"></textarea>
				  </td>
				</tr>
				<tr><td colspan="2" height="5"></td></tr>
                <tr>
				  <td width="50" valign="top">Tindakan/Terapi</td>
					<td >
					  <textarea class="easyui-textbox" type="text" name="terapi" id="terapi" data-options="multiline:true,required:true" style="height:65px;width:250px"></textarea>
					</td>
				 </tr>
				 <tr><td colspan="2" height="5"></td></tr>
               </table>
    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	if(row.status == 0){
				...
				$('#id_poli').val(row.ID_POLI_LANSIA);
        ...
        handler:function(){
        	...
        	if(row.TransStatus == 0){
    			suspend_data('<?= $menu_link->controller;?>/suspend_data','grid',row.ID_UMB_LANSIA);   
	        }
        }
    }];
