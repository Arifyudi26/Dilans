            <br>         
        <form id="fm_rujukan" action="<?= base_url().$menu_link->controller;?>/" method="post" enctype="multipart/form-data">
		    <table width="100%">
		    	...
		    	<tr>
		    		<td>
		    			<table width="95%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                               ...
                               <input type="hidden" name="id_poli_umum" id="id_poli_umum" value="<?=$group->ID_POLI_LANSIA;?>"  style="height:15px;width:250px;"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					...
					<td align="" valign="top">
		    			<table width="50%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_rujukan" id="id_rujukan" value="<?=$group->ID_RUJUKAN_LANSIA;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
					    		</td>
					    		<td align="right">
