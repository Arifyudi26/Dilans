...
<div class="easyui-layout" style="height:500px;width:100%" id="layout_<?= $menu_link->controller;?>">
		    	...
		    	<tr>
		    		<td>
		    			<table width="80%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                               ...
                               <input type="hidden" name="id_poli" id="id_poli" value="" style="height:15px;width:250px;"></input>
                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
                            <tr>
					...
					<td align="" valign="top">
		    			<table width="20%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_tou" id="id_tou" value="<?=$group->ID_RESOB_LANSIA;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
	...
	<div data-options="region:'center',title:'',iconCls:'icon-ok'" style="width:80%;height:260px;border:none;overflow:hidden">
		<table class="easyui-edatagrid" title="" style="height:250px" id="grid_detail"
		        ...
		        pagination:false,
	            pageSize:50,
		        url:'<?= base_url().$menu_link->controller;?>/get_detail_resep/<?=$group->ID_RESOB_LANSIA;?>',
		        method:'get',
		        toolbar:toolbar,
