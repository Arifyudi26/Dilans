          ...
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold">Input Data Terapi Obat</legend>
                <script src="<?php echo base_url("js/config_obat_lansia.js"); ?>"></script> <!-- Load file process.js -->
            ...
            <form class="form-horizontal" action="" method="post">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label col-lg-4">Id Medrec</label>
                    <div class="col-lg-8">
                      <input type="text" name="id_medrec" class="form-control" id="id_medrec" required maxlength="15">
                    </div>
                  </div>
                </div>
              </div>
