...
<div class="easyui-layout" style="height:450px;width:100%">
	...
	<div data-options="region:'center',title:'List <?=$menu_link->MenuLabel;?>',iconCls:'icon-ok'" style="width:80%;height:450px">
		<table class="easyui-datagrid" title="" style="width:100%;height:397px" id="grid"
		        ...
		        pagination:true,
                pageSize:20,
		        url:'<?= base_url().$menu_link->controller;?>/ajax_rawat',
		        method:'get',
		        toolbar:toolbar,
		        onDblClickRow:function(){
					...
					if(priedit == false){
        				parent.editPanel('New <?=$menu_link->MenuLabel;?>','<?=$menu_link->controller;?>/add',row.ID_DAFTAR_RB);
        			}
				}
			">
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'NAMA_LENGKAP',width:150,align:'left'">Nama Pasien</th>
...
<script type="text/javascript">
   ...
   function formatRawat(status){
    ...
    var toolbar = [{
        ...
        disabled:false,
        handler:function(){
        	parent.addPanel('Data <?= $menu_link->MenuLabel;?>','<?= $menu_link->controller;?>/data_pulang');
        }
