		    			...
		    			<table width="80%" cellpadding="0" cellspacing="0">
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
                             <tr>
				 				  ...
				 				  <td >
                    				<input class="easyui-textbox" type="text" name="alamat" id="alamat" value="<?=$group->ALAMAT;?>" data-options="multiline:true,required:true" style="height:45px;width:300px"></input>                              
                    </td>
				</tr>
				<tr><td colspan="2" height="5"></td></tr>
					...
					<td align="" valign="top">   
		    			<table width="20%" cellpadding="0" cellspacing="0">
		    				...
		    				<tr>
		    					<td align="right">
					    			<input class="easyui-textbox" name="id_pulang" id="id_pulang" value="<?=$gigi;?>" data-options="required:true" style="height:25px;width:200px" readonly="true"></input>
                         ...
                         <tr>
                          ...
                          <tr>
					        ...
					        <tr><td colspan="2" height="5"></td></tr>
					            ...
					            <td >
                               <input class="easyui-numberbox" data-options="required:true,precision:2,groupSeparator:'.',decimalSeparator:','" style="width:150px;height:30px" id="total_by" name="total_by" readonly="true">						                                </td>
					        </tr>
					        <tr><td colspan="2" height="5"></td></tr>
		    					</td>
		    				</tr>
                ...
                <td colspan="3">
                    <table id="list_pasien" class="easyui-datagrid" 
                        ...
                        <thead>
                            <tr>
                                <th data-options="field:'ck',checkbox:true"></th>
                                <th field="ID_DAFTAR_RB" data-options="field:'ID_DAFTAR_RB',width:150" sortable="true">Id Daftar RB</th>
